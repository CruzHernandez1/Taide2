...
urlpatterns = [
    ...
    path('Pools/Profile/My_reservation', views.My_reservations, name = 'My_reservation'),
    path('Pools/Profile/My_reservation/<int:Picina_id>', views.My_pool_reservations, name = 'My_pool_reservations'),
    ...
    path('Pools/My_reservation/View/<int:Contract_id>', views.View_contract, name = 'View_contract'),
